...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UpdateProfile.this, "Falha ao realizar Upload!", Toast.LENGTH_SHORT).show();
                    }
                }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(UpdateProfile.this, "Upload efetuado com sucesso!", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        updateProfilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(intent, "Selecionar uma imagem!"), PICK_IMAGE);
            }
        });
    }
    ...
    public Action getIndexApiAction() {
        return Actions.newView("UpdateProfile", "http://[ENTER-YOUR-URL-HERE]");
    }
